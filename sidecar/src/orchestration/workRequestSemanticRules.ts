...
export const SYSTEM_SHELL_ACTION_PATTERN = /(关机|重启|shutdown|reboot|poweroff|halt)/i;

export const SYSTEM_SHELL_ACTION_EXPLANATION_PATTERN =
    /(如何|怎么|怎样|为什么|为何|what|how|why|命令|command|教程|步骤|方案|方法|example|示例|\?)/i;
