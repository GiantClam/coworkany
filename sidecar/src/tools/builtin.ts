...
import { getIsolatedMemoryContext, resolveMemoryWriteTarget, searchIsolatedMemory } from '../runtime/memory/isolation';
...
export const searchVaultTool: ToolDefinition = {
    ...
    handler: async (
        ...
        try {
            // Dynamic import to avoid circular dependencies
            const { getRagBridge } = await import('../runtime/memory');
