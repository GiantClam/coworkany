...
const BUILTIN_TOOLPACK_ROWS: ToolpackManifest[] = [
    ...
    { id: 'builtin-voice', name: 'voice', version: '1.0.0', description: 'Built-in voice playback capability.', tools: ['voice_speak'], runtime: 'internal', tags: ['builtin', 'voice'], effects: ['ui:notify'] },
