...
export const BUILTIN_TOOLPACKS: ToolpackManifest[] = [
    ...
    { id: 'builtin-memory', name: 'memory', version: '1.0.0', description: 'Persistent memory for the agent. Stores data in .coworkany/memory.json.', tools: ['remember', 'recall'], runtime: 'internal', tags: ['builtin', 'memory'], effects: [] },
    { id: 'builtin-sequential-thinking', name: 'sequential-thinking', version: '2.0.0', description: 'Structured reasoning, sequential plan execution, and persistent findings.', tools: ['think', 'plan_step', 'log_finding'], runtime: 'internal', tags: ['builtin', 'reasoning'], effects: [] },
    ...
    { id: 'builtin-websearch', name: 'websearch', version: '1.0.0', description: 'Web search with multi-provider support (SearXNG, Tavily, Brave). Configure in llm-config.json.', tools: ['search_web'], runtime: 'internal', tags: ['builtin', 'web', 'search'], effects: ['network:outbound'] },
];
